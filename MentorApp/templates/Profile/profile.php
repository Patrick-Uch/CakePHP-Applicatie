<div class="p-6 bg-white shadow-md rounded-lg">
    ...
    <?= $this->Form->button(__('Opslaan'), ['class' => 'mt-4 bg-blue-600 text-white px-4 py-2 rounded-lg']); ?>
    <?= $this->Form->end() ?>
</div>
...
<div class="p-6 mt-8 bg-white shadow-md rounded-lg">
    ...
    <?= $this->Form->button(__('Wachtwoord bijwerken'), ['class' => 'mt-4 bg-blue-600 text-white px-4 py-2 rounded-lg']); ?>
    <?= $this->Form->end() ?>
</div>
