...
/**
 * Herinneringen Entity
 *
 * @property int $id
 * @property int $dossier_id
 * @property int|null $gebruiker_id
 * @property string $bericht
 * @property \Cake\I18n\DateTime $herinneringsdatum
 ...
 */
class Herinneringen extends Entity
{
    /**
